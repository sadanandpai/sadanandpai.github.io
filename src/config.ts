...
export const about = {
  ...
  majors: {
    "Web development":
      "Architecture & development of web apps using the industry best practices.",
    "Pixel-perfect design":
      "I convert complex designs to code which are modular and maintainable",
    "Open-Source Projects":
      "Building frontend projects and contributions in the open-source world.",
    "Content Creation":
      "I create content on frontend topics and give sessions on tech topics.",
  },
};
...
export const work = {
  projects: [
    ...
    },
    {
      ...
      link: "https://github.com/sadanandpai/sorting-visualizer",
    },
    {
      name: "Git Guide",
